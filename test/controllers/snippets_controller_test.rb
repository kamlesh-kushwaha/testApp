...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { highlighted_code: @snippet.highlighted_code, language: @snippet.language, plain_code: @snippet.plain_code, source: @snippet.source }
    end
  ...
  test "should update snippet" do
    patch :update, id: @snippet, snippet: { highlighted_code: @snippet.highlighted_code, language: @snippet.language, plain_code: @snippet.plain_code, source: @snippet.source }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
